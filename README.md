...
Oben links gibt es eine feste Navigation mit zwei Reitern: **„Loris Klinke“** (zurück zur Werkübersicht) und **„Work“** (springt zum Lebenslauf-Abschnitt ganz unten). Beide bleiben beim Scrollen/Wischen sichtbar.
...
- **„Loris Klinke“** springt zurück zum ersten Werk (Meridian).
- **„Work“** springt zum Lebenslauf-Abschnitt.
- Der aktive Reiter wird durch einen dünnen Unterstrich in der Akzentfarbe hervorgehoben.

...
- **Desktop:** Pfeiltasten `←`/`→` bzw. `↑`/`↓` springen jederzeit zum vorherigen/nächsten Projekt (auch bei offenem Panel). Ein Klick auf das Foto wechselt nur, solange das Panel noch komplett geschlossen ist (`revealProgress` = 0) — ist es angeschoben oder offen, übernehmen Panel-Buttons oder Pfeiltasten.

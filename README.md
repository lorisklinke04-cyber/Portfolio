...
- `.info-head`: `<span class="tag">` (Kategorie/Jahr, z. B. `Photography — 2024`), `<h2>` (Projekttitel) und optional das Karussel direkt darunter
...
:root {
  ...
  --display-font: 'Roboto Mono', monospace;   /* Navigation */
